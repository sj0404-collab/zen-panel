  ...
  const providerRule = currentProvider === 'openrouter'
    ...
    : currentProvider === 'tokenra'
      ...
      : currentProvider === 'huggingface'
        ...
        : currentProvider === 'local'
          ? 'Провайдер Local AI: используй TOOL_JSON fallback строго по схеме для каждого нужного инструмента. Агент проверит и выполнит вызов, затем вернёт результат в следующий раунд. Не пиши инструменты как обычный текст и не останавливайся после первого результата.'
